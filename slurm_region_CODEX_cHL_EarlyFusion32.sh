...
OUT=/nobackup/lab_taschner-mandl/simongutwein/z_RUNS/region_analysis/CODEX_cHL_EarlyFusion32_ps128

mkdir -p "$OUT"

EMB=/nobackup/lab_taschner-mandl/simongutwein/z_RUNS/region_analysis/embeddings/CODEX_cHL_EarlyFusion32_ps128
