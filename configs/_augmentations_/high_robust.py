train_aug_strong = [
    ...
    dict(type='C_RandomChannelShiftScale', scale=(0.33, 3), shift=(-0.15, 0.15), clip=True),
...
# Weak view with broader channel intensity range to prevent the model
# from using per-sample absolute intensities as a shortcut.
# scale (0.5, 2.0) vs original (0.9, 1.1) — 4x range instead of 1.1x.
train_aug_weak = [
