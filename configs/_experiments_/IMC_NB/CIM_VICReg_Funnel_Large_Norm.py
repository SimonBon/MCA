...
_DATA = '/nobackup/lab_taschner-mandl/simongutwein/h5_files/IMC_NeuroblastomaMetaCluster'
_base_.h5_filepath    = f'{_DATA}/IMC_NeuroblastomaMetaCluster.h5'
...
train_aug_strong = [
    ...
    dict(type='C_CentralCutter',           size=14),
...
_base_.val_augmentation[0].size = 12
...
work_dir = '/nobackup/lab_taschner-mandl/simongutwein/z_RUNS/IMC_NeuroblastomaMetaCluster_CIM_VICReg_Funnel_Large_Norm'
