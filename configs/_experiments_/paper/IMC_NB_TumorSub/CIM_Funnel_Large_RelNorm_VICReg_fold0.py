...
_base_ = [
    ...
    '../../../_backbones_/CIM_Funnel_Large_RelNorm.py',
...
_base_.train_indicies = '/nobackup/lab_taschner-mandl/simongutwein/h5_files/IMC_NB_TumorSub/train.txt'
_base_.test_indicies  = '/nobackup/lab_taschner-mandl/simongutwein/h5_files/IMC_NB_TumorSub/test.txt'
...
work_dir = '/nobackup/lab_taschner-mandl/simongutwein/z_RUNS/paper_clean/IMC_NB_TumorSub/CIM_Funnel_Large_RelNorm'
