...
_base_ = [
    ...
    '../../../../configs/_base_/val_cfg.py',
    '../../../../configs/_datasets_/CODEX_cHL.py',
    '../../../../configs/_backbones_/CIM_ProgFusion.py',
    '../../../../configs/_algorithms_/VICReg.py',
]
...
# ── Augmentations ─────────────────────────────────────────────────────────────
# CODEX_cHL: patch_size=32, cutter_size=24 → strong=20, weak=18, val=18
train_aug_strong = [
...
work_dir = '/home/simon_g/isilon_images_mnt/10_MetaSystems/MetaSystemsData/_simon/src/MCA/z_RUNS/paper/CODEX_cHL/CIM_ProgFusion'
