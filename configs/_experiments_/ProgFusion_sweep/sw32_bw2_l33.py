...
_base_.model.backbone.layer_config  = [3, 3]
_base_.model.neck.in_channels       = _base_.n_markers * 32

work_dir = '/home/simon_g/isilon_images_mnt/10_MetaSystems/MetaSystemsData/_simon/src/MCA/z_RUNS/ProgFusion_sweep/sw32_bw2_l33'
