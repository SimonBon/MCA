...
_base_.model.backbone.stem_width    = 64
_base_.model.backbone.block_width   = 2
_base_.model.backbone.layer_config  = [1, 1]
_base_.model.neck.in_channels       = _base_.n_markers * 64

work_dir = '/home/simon_g/isilon_images_mnt/10_MetaSystems/MetaSystemsData/_simon/src/MCA/z_RUNS/ProgFusion_sweep/sw64_bw2_l11'
