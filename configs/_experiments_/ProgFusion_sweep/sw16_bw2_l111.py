...
# ── Eval hook — lightweight for sweep ─────────────────────────────────────────
dataset_kwargs = dict(
...
_base_.custom_hooks[0].epochs             = 500
_base_.custom_hooks[0].max_samples        = 15000
_base_.custom_hooks[0].le_fractions       = []
_base_.custom_hooks[0].le_n_per_class     = []

# ── Model: backbone variant ────────────────────────────────────────────────────
_base_.model.backbone               = _base_.backbone
_base_.model.backbone.in_channels   = _base_.n_markers
_base_.model.backbone.stem_width    = 16
_base_.model.backbone.block_width   = 2
_base_.model.backbone.layer_config  = [1, 1, 1]
_base_.model.neck.in_channels       = _base_.n_markers * 16

work_dir = '/home/simon_g/isilon_images_mnt/10_MetaSystems/MetaSystemsData/_simon/src/MCA/z_RUNS/ProgFusion_sweep/sw16_bw2_l111'
