...
_DATA = '/nobackup/lab_taschner-mandl/simongutwein/h5_files/IMC_NB_FineCT'
_base_.h5_filepath    = f'{_DATA}/IMC_NB_FineCT.h5'
...
work_dir = '/nobackup/lab_taschner-mandl/simongutwein/z_RUNS/IMC_NB_FineCT_CIM_VICReg_Funnel_Large_Norm'
