...
_DATA = '/nobackup/lab_taschner-mandl/simongutwein/h5_files/CODEX_DLBCL2'
_base_.h5_filepath    = f'{_DATA}/CODEX_DLBCL2.h5'
...
work_dir = '/nobackup/lab_taschner-mandl/simongutwein/z_RUNS/CODEX_DLBCL2_CIM_VICReg_Funnel_Large_Norm'
