...
_base_.model.backbone.mix_channels = 768
_base_.model.backbone.mix_n_blocks = 8
_base_.model.neck.in_channels     = 768

work_dir = '/nobackup/lab_taschner-mandl/simongutwein/z_RUNS/ablations/CIM_Funnel/cap_ch_768'
