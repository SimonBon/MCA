...
train_aug_strong = [
    ...
    dict(type='C_RandomAffine',            angle=(0, 360), scale=(0.5, 1.8), shift=(-0.15, 0.15), order=1),
    dict(type='C_RandomChannelShiftScale', scale=(0.1, 5.0), shift=(-0.2, 0.2), clip=True),
    dict(type='C_RandomBackgroundGradient', strength=(-0.3, 0.3), clip=True),
    dict(type='C_RandomNoise',             mean=(0, 0), std=(0, 0.1), clip=True),
    dict(type='C_RandomChannelCopy',       copy_prob=0.1),
    dict(type='C_RandomChannelMixup',      mixup_prob=0.15),
    dict(type='C_RandomChannelDrop',       drop_prob=0.3),
...
train_aug_weak = [
    ...
    dict(type='C_RandomChannelShiftScale', scale=(0.2, 3.0), shift=(-0.15, 0.15), clip=True),
    ...
    dict(type='C_RandomChannelDrop',       drop_prob=0.15),
...
work_dir = '/nobackup/lab_taschner-mandl/simongutwein/z_RUNS/CODEX_cHL_CIM_VeryStrongAug_KRONOS18_VICReg'
