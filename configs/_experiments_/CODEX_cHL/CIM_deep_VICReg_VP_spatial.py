...
_base_ = [
    '../../_base_/default.py',
    '../../_base_/augmentations_spatial_only.py',
    '../../_base_/train_cfg_long.py',
    '../../_base_/val_cfg.py',
    '../../_datasets_/CODEX_cHL.py',
    '../../_backbones_/CIM_deep.py',
...
_base_.custom_hooks[0].epochs = 4000
...
_base_.model.neck.hid_channels = 1024
_base_.model.neck.out_channels = 512

work_dir = '/home/simon_g/isilon_images_mnt/10_MetaSystems/MetaSystemsData/_simon/src/MCA/z_RUNS/CODEX_cHL_CIM_DEEP_VICReg_SPATIAL_VP'
