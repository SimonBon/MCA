...
train_aug_v1 = _shared + [dict(type='C_CentralCutter', size=22), dict(type='C_ToTensor')]
train_aug_v2 = _shared + [dict(type='C_CentralCutter', size=20), dict(type='C_ToTensor')]
train_aug_v3 = _shared + [dict(type='C_CentralCutter', size=18), dict(type='C_ToTensor')]
train_aug_v4 = _shared + [dict(type='C_CentralCutter', size=16), dict(type='C_ToTensor')]
...
_base_.model.neck.in_channels     = _base_.mix_channels
