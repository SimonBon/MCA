...
# Increase invariance coefficient to encourage smoother, less fragmented clusters.
# Default sim_coeff=25.0; raised 4x to pull augmented views together more strongly.
_base_.model.sim_coeff = 100.0

work_dir = '/home/simon_g/isilon_images_mnt/10_MetaSystems/MetaSystemsData/_simon/src/MCA/z_RUNS/MIBI_TNBC_CIMATT_Gate_VICReg_HighInv'
