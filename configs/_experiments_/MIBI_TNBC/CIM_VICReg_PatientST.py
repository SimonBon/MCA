...
# ── Augmentations ─────────────────────────────────────────────────────────────
# C_PatientStyleTransfer is applied to both views independently.
# Each view gets teleported to a randomly drawn patient's intensity profile,
# forcing VICReg's invariance loss to learn representations that are invariant
# to per-patient staining variation.
...
train_aug_strong = [
    ...
    _pst,  # remove source patient intensity, add random target patient intensity
