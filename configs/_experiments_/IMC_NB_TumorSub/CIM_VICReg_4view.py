...
_DATA = '/nobackup/lab_taschner-mandl/simongutwein/h5_files/IMC_NB_TumorSub'
_base_.h5_filepath    = f'{_DATA}/IMC_NB_TumorSub.h5'
...
# ── 4-view augmentations (14, 12, 10, 8 px crops) ────────────────────────────
_shared = [
...
train_aug_v1 = _shared + [dict(type='C_CentralCutter', size=14), dict(type='C_ToTensor')]
train_aug_v2 = _shared + [dict(type='C_CentralCutter', size=12), dict(type='C_ToTensor')]
train_aug_v3 = _shared + [dict(type='C_CentralCutter', size=10), dict(type='C_ToTensor')]
train_aug_v4 = _shared + [dict(type='C_CentralCutter', size=8),  dict(type='C_ToTensor')]
...
work_dir = '/nobackup/lab_taschner-mandl/simongutwein/z_RUNS/IMC_NB_TumorSub_CIM_4view_VICReg'
