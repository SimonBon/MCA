train_aug_strong = [
    ...
    dict(type='C_RandomChannelShiftScale', scale=(0.95, 1.05), shift=(-0.01, 0.01), clip=True),
...
train_aug_weak = [
    ...
    dict(type='C_RandomChannelShiftScale', scale=(0.98, 1.02), shift=(-0.005, 0.005), clip=True),
