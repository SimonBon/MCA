#!/bin/bash
#SBATCH --job-name=CIM_Funnel_TNBC
#SBATCH --output=/home/sgutwein/logs/CIM_Funnel_TNBC_%j.log
#SBATCH --error=/home/sgutwein/logs/CIM_Funnel_TNBC_%j.log
...
echo "Starting: CIM_Funnel MIBI_TNBC"
echo "Config: $CFG"
echo "Date: $(date)"
