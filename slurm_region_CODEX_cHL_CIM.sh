...
OUT=/nobackup/lab_taschner-mandl/simongutwein/z_RUNS/region_analysis/CODEX_cHL_CIM_ps64

mkdir -p "$OUT"

EMB=/nobackup/lab_taschner-mandl/simongutwein/z_RUNS/region_analysis/embeddings/CODEX_cHL_CIM_ps64
