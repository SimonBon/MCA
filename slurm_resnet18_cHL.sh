#!/bin/bash
#SBATCH --job-name=ResNet18_cHL
#SBATCH --output=/home/sgutwein/logs/ResNet18_cHL_%j.log
#SBATCH --error=/home/sgutwein/logs/ResNet18_cHL_%j.log
...
python /home/sgutwein/src/mmselfsup/tools/train.py \
    /home/sgutwein/src/MCA/configs/_experiments_/paper/CODEX_cHL/ResNet18_VICReg.py
