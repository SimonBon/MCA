...
optimizer = dict(lr=0.0003, type='AdamW', weight_decay=0.05)
param_scheduler = [
    dict(begin=0, by_epoch=False, end=5, start_factor=0.0001, type='LinearLR'),
    dict(
        T_max=5,
        begin=5,
        by_epoch=False,
...
train_cfg = dict(max_iters=10, type='IterBasedTrainLoop')
...
work_dir = '/home/simon_g/isilon_images_mnt/10_MetaSystems/MetaSystemsData/_simon/src/MCA/z_RUNS/CODEX_cHL_ablations/capacity_stem64'
