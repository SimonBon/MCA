...
param_scheduler = [
    dict(
        begin=0, by_epoch=False, end=100, start_factor=0.0001,
        type='LinearLR'),
    dict(
        T_max=400,
        begin=100,
...
work_dir = '/home/simon_g/isilon_images_mnt/10_MetaSystems/MetaSystemsData/_simon/src/MCA/z_RUNS/CODEX_cHL_ablations/iters_500'
