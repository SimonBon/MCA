...
custom_hooks = [
    dict(
        dataset_kwargs=dict(
            h5_filepath=
            '/home/simon_g/isilon_images_mnt/10_MetaSystems/MetaSystemsData/_simon/data/MCI_data/h5_files/MIBI_TNBC/MIBI_TNBC.h5',
            ignore_annotation=[
                'Unidentified',
            ],
            patch_size=32,
            used_markers=
            '/home/simon_g/isilon_images_mnt/10_MetaSystems/MetaSystemsData/_simon/data/MCI_data/h5_files/MIBI_TNBC/used_markers.txt'
        ),
        epochs=1000,
        max_samples=None,
        n_jobs=8,
        ...
        train_indicies=
        '/home/simon_g/isilon_images_mnt/10_MetaSystems/MetaSystemsData/_simon/data/MCI_data/h5_files/MIBI_TNBC/cv_splits/split_1/train.txt',
        type='EvaluateModelRich',
        val_indicies=
        '/home/simon_g/isilon_images_mnt/10_MetaSystems/MetaSystemsData/_simon/data/MCI_data/h5_files/MIBI_TNBC/cv_splits/split_1/val.txt'
    ),
]
custom_imports = dict(
...
train_aug_weak = [
    ...
    dict(drop_prob=0.025, type='C_RandomChannelDrop'),
    dict(size=20, type='C_CentralCutter'),
    dict(type='C_ToTensor'),
]
...
train_indicies = '/home/simon_g/isilon_images_mnt/10_MetaSystems/MetaSystemsData/_simon/data/MCI_data/h5_files/MIBI_TNBC/cv_splits/split_1/train.txt'
train_pipeline = [
    dict(
        n_views=[
            1,
...
val_indicies = '/home/simon_g/isilon_images_mnt/10_MetaSystems/MetaSystemsData/_simon/data/MCI_data/h5_files/MIBI_TNBC/cv_splits/split_1/val.txt'
val_pipeline = [
    dict(
        n_views=[
            1,
...
work_dir = '/home/simon_g/isilon_images_mnt/10_MetaSystems/MetaSystemsData/_simon/src/MCA/z_RUNS/MIBI_TNBC_CV1_CIM_ProgFusion_VICReg'
