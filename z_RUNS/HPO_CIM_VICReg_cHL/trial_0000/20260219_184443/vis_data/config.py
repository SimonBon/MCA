...
model = dict(
    ...
    neck=dict(
        ...
        type='NonLinearNeck',
        with_avg_pool=False),
    sim_coeff=32.0501755284444,
    std_coeff=36.86326600082205,
    type='MVVICReg')
optim_wrapper = dict(
    optimizer=dict(
...
work_dir = '/home/simon_g/isilon_images_mnt/10_MetaSystems/MetaSystemsData/_simon/src/MCA/z_RUNS/HPO_CIM_VICReg_cHL/trial_0000'
