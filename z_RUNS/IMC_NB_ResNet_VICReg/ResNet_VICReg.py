backbone = dict(
    base_width=64, drop_prob=0.05, in_channels=31, type='ResNetBaseline')
batch_size = 256
custom_hooks = [
    dict(
        dataset_kwargs=dict(
            h5_filepath=
            '/home/simon_g/isilon_images_mnt/10_MetaSystems/MetaSystemsData/_simon/data/MCI_data/h5_files/IMC_NeuroblastomaMetaCluster/IMC_NeuroblastomaMetaCluster.h5',
            ignore_annotation=None,
            patch_size=24,
            used_markers=
            '/home/simon_g/isilon_images_mnt/10_MetaSystems/MetaSystemsData/_simon/data/MCI_data/h5_files/IMC_NeuroblastomaMetaCluster/used_markers.txt'
        ),
        epochs=1000,
        max_samples=None,
        pipeline=[
        ...
        train_indicies=
        '/home/simon_g/isilon_images_mnt/10_MetaSystems/MetaSystemsData/_simon/data/MCI_data/h5_files/IMC_NeuroblastomaMetaCluster/train.txt',
        type='EvaluateModelRich',
        val_indicies=
        '/home/simon_g/isilon_images_mnt/10_MetaSystems/MetaSystemsData/_simon/data/MCI_data/h5_files/IMC_NeuroblastomaMetaCluster/val.txt'
    ),
]
custom_imports = dict(
...
work_dir = '/home/simon_g/isilon_images_mnt/10_MetaSystems/MetaSystemsData/_simon/src/MCA/z_RUNS/IMC_NB_ResNet_VICReg'
