backbone = dict(
    base_width=64, drop_prob=0.05, in_channels=37, type='ResNetBaseline')
batch_size = 256
custom_hooks = [
    dict(
        dataset_kwargs=dict(
...
work_dir = '/home/simon_g/isilon_images_mnt/10_MetaSystems/MetaSystemsData/_simon/src/MCA/z_RUNS/MIBI_TNBC_ResNet_VICReg'
