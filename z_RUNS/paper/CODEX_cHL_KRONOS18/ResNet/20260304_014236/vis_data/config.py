backbone = dict(
    base_width=64, drop_prob=0.05, in_channels=18, type='ResNetBaseline')
batch_size = 512
custom_hooks = [
    dict(
        dataset_kwargs=dict(
            ...
            used_markers=
            '/home/simon_g/isilon_images_mnt/10_MetaSystems/MetaSystemsData/_simon/data/MCI_data/h5_files/CODEX_cHL/used_markers_KRONOS18.txt'
        ),
        epochs=2000,
        max_samples=None,
        n_jobs=8,
...
work_dir = '/home/simon_g/isilon_images_mnt/10_MetaSystems/MetaSystemsData/_simon/src/MCA/z_RUNS/paper/CODEX_cHL_KRONOS18/ResNet'
