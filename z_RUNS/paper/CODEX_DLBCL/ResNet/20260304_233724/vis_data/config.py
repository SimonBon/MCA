backbone = dict(
    base_width=64, drop_prob=0.05, in_channels=40, type='ResNetBaseline')
batch_size = 512
custom_hooks = [
    dict(
        dataset_kwargs=dict(
            h5_filepath=
            '/home/simon_g/isilon_images_mnt/10_MetaSystems/MetaSystemsData/_simon/data/MCI_data/h5_files/CODEX_DLBCL2/CODEX_DLBCL2.h5',
            ignore_annotation=[
                'na',
            ],
            patch_size=24,
            preprocess=None,
            used_indicies=
            '/home/simon_g/isilon_images_mnt/10_MetaSystems/MetaSystemsData/_simon/data/MCI_data/h5_files/CODEX_DLBCL2/train.txt',
            used_markers=
            '/home/simon_g/isilon_images_mnt/10_MetaSystems/MetaSystemsData/_simon/data/MCI_data/h5_files/CODEX_DLBCL2/used_markers.txt'
        ),
        epochs=2000,
        max_samples=None,
        n_jobs=8,
        ...
        val_indicies=
        '/home/simon_g/isilon_images_mnt/10_MetaSystems/MetaSystemsData/_simon/data/MCI_data/h5_files/CODEX_DLBCL2/val.txt'
    ),
]
custom_imports = dict(
...
work_dir = '/home/simon_g/isilon_images_mnt/10_MetaSystems/MetaSystemsData/_simon/src/MCA/z_RUNS/paper/CODEX_DLBCL/ResNet'
