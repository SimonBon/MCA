...
custom_hooks = [
    dict(
        ...
        train_indicies=
        '/home/simon_g/isilon_images_mnt/10_MetaSystems/MetaSystemsData/_simon/data/MCI_data/h5_files/MIBI_TNBC/train.txt',
        type='EvaluateModelRich',
        val_indicies=
        '/home/simon_g/isilon_images_mnt/10_MetaSystems/MetaSystemsData/_simon/data/MCI_data/h5_files/MIBI_TNBC/val.txt'
    ),
]
custom_imports = dict(
...
work_dir = '/home/simon_g/isilon_images_mnt/10_MetaSystems/MetaSystemsData/_simon/src/MCA/z_RUNS/paper/MIBI_TNBC/CIM_ProgFusion'
