...
custom_hooks = [
    dict(
        ...
        train_indicies=
        '/home/simon_g/isilon_images_mnt/10_MetaSystems/MetaSystemsData/_simon/data/MCI_data/h5_files/MIBI_TNBC/cv_splits/split_0/train.txt',
        type='EvaluateModelRich',
        val_indicies=
        '/home/simon_g/isilon_images_mnt/10_MetaSystems/MetaSystemsData/_simon/data/MCI_data/h5_files/MIBI_TNBC/cv_splits/split_0/val.txt'
    ),
]
custom_imports = dict(
...
train_indicies = '/home/simon_g/isilon_images_mnt/10_MetaSystems/MetaSystemsData/_simon/data/MCI_data/h5_files/MIBI_TNBC/cv_splits/split_0/train.txt'
train_pipeline = [
    dict(
        n_views=[
            1,
...
val_indicies = '/home/simon_g/isilon_images_mnt/10_MetaSystems/MetaSystemsData/_simon/data/MCI_data/h5_files/MIBI_TNBC/cv_splits/split_0/val.txt'
val_pipeline = [
    dict(
        n_views=[
            1,
...
work_dir = '/home/simon_g/isilon_images_mnt/10_MetaSystems/MetaSystemsData/_simon/src/MCA/z_RUNS/MIBI_TNBC_CV0_CIM_ProgFusion_VICReg'
