...
custom_hooks = [
    dict(
        dataset_kwargs=dict(
            h5_filepath=
            '/home/simon_g/isilon_images_mnt/10_MetaSystems/MetaSystemsData/_simon/data/MCI_data/h5_files/IMC_NB_FineCT/IMC_NB_FineCT.h5',
            ignore_annotation=[
                'Other',
            ],
            patch_size=24,
            used_markers=
            '/home/simon_g/isilon_images_mnt/10_MetaSystems/MetaSystemsData/_simon/data/MCI_data/h5_files/IMC_NB_FineCT/used_markers.txt'
        ),
        epochs=1000,
        max_samples=None,
        n_jobs=8,
        ...
        train_indicies=
        '/home/simon_g/isilon_images_mnt/10_MetaSystems/MetaSystemsData/_simon/data/MCI_data/h5_files/IMC_NB_FineCT/train.txt',
        type='EvaluateModelRich',
        val_indicies=
        '/home/simon_g/isilon_images_mnt/10_MetaSystems/MetaSystemsData/_simon/data/MCI_data/h5_files/IMC_NB_FineCT/val.txt'
    ),
]
custom_imports = dict(
...
train_aug_mid = [
    ...
    dict(copy_prob=0.03, type='C_RandomChannelCopy'),
    dict(mixup_prob=0.03, type='C_RandomChannelMixup'),
    dict(drop_prob=0.06, type='C_RandomChannelDrop'),
    dict(size=12, type='C_CentralCutter'),
    dict(type='C_ToTensor'),
]
...
work_dir = '/home/simon_g/isilon_images_mnt/10_MetaSystems/MetaSystemsData/_simon/src/MCA/z_RUNS/IMC_NB_FineCT_CIM_Norm_Large_VICReg'
