...
custom_hooks = [
    dict(
        dataset_kwargs=dict(
            ...
            patch_size=24,
            preprocess=dict(c=2.5, rescale=False, type='tanhNormalizer'),
            used_indicies=
            '/home/simon_g/isilon_images_mnt/10_MetaSystems/MetaSystemsData/_simon/data/MCI_data/h5_files/CODEX_DLBCL2/train_LN0251.txt',
            used_markers=
        ...
        type='EvaluateModel',
        val_indicies=
        '/home/simon_g/isilon_images_mnt/10_MetaSystems/MetaSystemsData/_simon/data/MCI_data/h5_files/CODEX_DLBCL2/val_LN0265.txt'
    ),
]
custom_imports = dict(
...
work_dir = '/home/simon_g/isilon_images_mnt/10_MetaSystems/MetaSystemsData/_simon/src/MCA/z_RUNS/CODEX_DLCBL_CIM_VICReg_BATCHES_TANH'
