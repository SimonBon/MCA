annotation_map = dict(CD4='CD4 T cell', TReg='CD4 T cell')
backbone = dict(
    block_width=2,
    drop_prob=0.05,
    in_channels=41,
...
work_dir = '/home/simon_g/isilon_images_mnt/10_MetaSystems/MetaSystemsData/_simon/src/MCA/z_RUNS/CODEX_cHL_CIM_VICReg_merged'
