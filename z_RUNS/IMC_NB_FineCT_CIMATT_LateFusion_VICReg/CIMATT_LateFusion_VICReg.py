backbone = dict(
    ...
    n_heads=4,
    stem_width=32,
    type='WideModelAttentionLateFusion')
batch_size = 256
custom_hooks = [
    dict(
        dataset_kwargs=dict(
...
work_dir = '/home/simon_g/isilon_images_mnt/10_MetaSystems/MetaSystemsData/_simon/src/MCA/z_RUNS/IMC_NB_FineCT_CIMATT_LateFusion_VICReg'
