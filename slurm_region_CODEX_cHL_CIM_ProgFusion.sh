#!/bin/bash
#SBATCH --job-name=region_cHL_ProgFusion
#SBATCH --output=/home/sgutwein/logs/region_cHL_CIM_ProgFusion_%j.log
#SBATCH --error=/home/sgutwein/logs/region_cHL_CIM_ProgFusion_%j.log
...
OUT=/nobackup/lab_taschner-mandl/simongutwein/z_RUNS/region_analysis/CODEX_cHL_CIM_ProgFusion
