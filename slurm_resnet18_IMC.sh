#!/bin/bash
#SBATCH --job-name=ResNet18_IMC
#SBATCH --output=/home/sgutwein/logs/ResNet18_IMC_%A_%a.log
#SBATCH --error=/home/sgutwein/logs/ResNet18_IMC_%A_%a.log
...
python /home/sgutwein/src/mmselfsup/tools/train.py \
    /home/sgutwein/src/MCA/configs/_experiments_/paper/IMC_NB_TumorSub/ResNet18_VICReg_fold${SLURM_ARRAY_TASK_ID}.py
